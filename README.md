...
No requiere alguna configuración especial, solo debe clonarse el proyecto, posteriormente debe crearse en raíz una carpeta llamada 'asset' (ver abajo más detalles sobre esta carpeta).
